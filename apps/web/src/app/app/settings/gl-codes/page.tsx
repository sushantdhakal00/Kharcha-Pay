...
import { GLCodesClient } from "./gl-codes-client";
...
export default async function GLCodesPage() {
  ...
  return (
    <div>
      ...
      <h1 className="mt-4 text-xl font-semibold text-slate-900 dark:text-slate-100">GL Codes</h1>
      <GLCodesClient orgId={active.id} />
    </div>
  );
}
