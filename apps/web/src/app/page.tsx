    ...
    <main className="min-h-screen gradient-mesh landing-scroll noise-overlay relative overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 spotlight">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 text-center">
          ...
          >
            <span className="text-white">Public Money.</span>
            <br />
            <span className="gradient-text">Private Accountability.</span>
          </h1>
          ...
          >
            Government agencies, NGOs, schools, and institutions lose trust when spending is opaque, approvals are informal, and payments cannot be audited end to end.
            KharchaPay turns expense management into a controlled system: request, approve, pay, and verify every disbursement with a clear record.
          </p>
      ...
      <section className="relative py-24 border-t border-stone-800/40">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="text-center mb-12">
            <p className="text-slate-500 text-sm uppercase tracking-wider mb-4">Built for institutions that need proof, not promises</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: 3, suffix: "", label: "Control layers: request, approval, payment" },
              { value: 1, suffix: "", label: "Payment trail from origin to settlement" },
              { value: 100, suffix: "%", label: "Audit-ready payment references" },
              { value: 24, suffix: "/7", label: "Treasury visibility" },
            ].map((stat, i) => (
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              KharchaPay is designed for the places where leakage happens: unclear ownership, weak approvals, missing receipts, and payments nobody can reconstruct later.
            </p>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <TimelineStep
              number={1}
              title="Define who can request, approve, and pay"
              description="Set up departments, budgets, approval thresholds, and treasury controls before money moves. KharchaPay forces role clarity so one person cannot quietly control the full flow."
              delay={0}
            />
            <TimelineStep
              number={2}
              title="Turn spending into a governed workflow"
              description="Staff submit requests with receipts and vendor details. Approvers review against budget and policy. Every step is logged, so exceptions and overrides are visible instead of buried in chat or spreadsheets."
              delay={200}
            />
            <TimelineStep
              number={3}
              title="Pay with a record that can be checked later"
              description="Approved payments are executed with verifiable references on Solana. That creates a durable link between the original request, the authorization path, and the final transfer."
              delay={400}
              isLast
            />
          </div>
      ...
      <section id="features" className="relative py-24 border-t border-stone-800/40">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              The problem is not only moving money. The problem is controlling who asked for it, who approved it, whether policy was followed, and whether the payment can be proven afterward.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <BentoCard className="md:col-span-2" delay={0}>
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 mb-6">Separate operational, hot, and controlled treasury functions so institutional funds are not managed like a personal wallet. Spending limits, safety controls, and approval logic reduce misuse and operational risk.</p>
            ...
            <BentoCard delay={100}>
              <div className="h-full flex flex-col">
                ...
                <p className="text-slate-400 flex-1">Strong auth, step-up reauthorization for sensitive actions, encrypted secrets, and immutable audit records help stop unauthorized payments and quiet internal manipulation.</p>
            ...
            <BentoCard delay={200}>
              ...
              <p className="text-slate-400">Approval chains are tied to amount thresholds and roles. KharchaPay enforces separation of duties so request, approval, and payment do not collapse into a single unchecked decision.</p>
            </BentoCard>
            ...
            <BentoCard delay={300}>
              ...
              <p className="text-slate-400">Settlement happens quickly, but speed is not the point by itself. The point is that every payment can carry a verifiable reference back to the institution's approval record.</p>
            </BentoCard>
            ...
            <BentoCard delay={400}>
              ...
              <p className="text-slate-400">Accounting sync keeps finance books aligned with actual disbursements, reducing the gap between what was approved, what was paid, and what was reported.</p>
            </BentoCard>
            ...
            <BentoCard className="md:col-span-2" delay={500}>
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-400 mb-6">Corruption and leakage often happen between procurement and payment, not only at the last step. KharchaPay connects purchase orders, receipts, invoices, and payments into one reviewable chain.</p>
            ...
            <BentoCard delay={600}>
              <div className="h-full flex flex-col">
                ...
                <p className="text-slate-400 flex-1">Admins, approvers, staff, and auditors each get distinct permissions. Auditors can inspect the record without getting operational power, which matters for public institutions and donor-funded programs.</p>
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
          <div className="glass-card rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Ready to make payments easier to trust?
              </h2>
              <p className="text-slate-400 mb-8 max-w-xl mx-auto">
                KharchaPay is for organizations that need stronger payment management, cleaner approvals, and a defensible audit trail, especially where public trust and institutional accountability matter.
              </p>
